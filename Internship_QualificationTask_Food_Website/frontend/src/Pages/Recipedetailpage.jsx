...
const Recipedetailpage = () => {
  ...
  const handleAddToCart = () => {
    // Navigate to cart with the recipe data
    navigate('/cart', { state: { recipe } });
  };
          ...
          <div className="lg:w-1/3">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mb-6 sticky top-24">
              ...
              <button 
                ...
                className="w-full mb-4 px-6 py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors font-semibold text-lg"
              >
                Add to Cart
              </button>
        ...
        <div className="mt-12 bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl p-8 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              className="px-8 py-3 bg-white text-orange-600 rounded-full hover:bg-gray-100 transition-colors font-semibold"
            >
